...
public class ServiceStarter extends AppCompatActivity {
    ...
    private Handler timeServiceCallbackHander = new Handler(){
    ...
    private ServiceConnection timeServiceConnection = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName name, IBinder service) {
            ...
            timeService.setActivityCallbackHandler(timeServiceCallbackHander);
        }
    ...
    protected void onDestroy() {
        Log.d(TAG, "onDestroy");
        if (serviceStarted) {
            timeServiceCallbackHander.removeCallbacksAndMessages(null);
